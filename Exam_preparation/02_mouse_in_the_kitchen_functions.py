def get_input_matrix():
    ...
    return matrix, cheese_count, current_position, R, C

def move_mouse(matrix, current_position, R, C, cheese_count):
    directions = {
        'up': (-1, 0),
        'down': (1, 0),
        'left': (0, -1),
...
def main():
    matrix, cheese_count, current_position, R, C = get_input_matrix()
    move_mouse(matrix, current_position, R, C, cheese_count)
